...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="post" class="my-5  border border-secondary round" enctype="multipart/form-data">
            <div class="form-input">
                <label for="nama">nama lengkap </label>
                <input class="form-control" type="text" id="nama" name="nama" placeholder="Muhammad Kevin Almer"
                    required>
            </div>
            <div class="form-input">
                <label for="tentang">tentang dirimu </label>
                <input class="form-control" type="text" id="tentang" name="tentang"
                    placeholder="Pecinta film klasik dan programer" required>
            </div>
            <div class="form-input">
